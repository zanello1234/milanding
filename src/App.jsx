                ...
                <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-300">
                        <button
                            ...
                            className={`text-sm font-medium transition-colors ${audience === 'business' ? 'text-indigo-400 font-bold' : 'text-slate-300 hover:text-white'}`}
                        >
                            Empresas
                        </button>
                        <button
                            onClick={() => setAudience('accounting')}
                            className={`text-sm font-medium transition-colors ${audience === 'accounting' ? 'text-brand-warm font-bold' : 'text-slate-300 hover:text-white'}`}
                        >
                            Estudios Contables
                        </button>
